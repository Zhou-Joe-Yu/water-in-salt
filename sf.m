...
%plot(xaxis,S_test{3,3},'-r','linewidth',2);hold on %S-S
%plot(xaxis,S_test{3,5},'-b','linewidth',2);hold on %S-N
%plot(xaxis,S_test{2,6}-1.5.*ones(1,201),':r','linewidth',2);hold on %F-C
%plot(xaxis,S_test{2,2}-2.0.*ones(1,201),':b','linewidth',2);hold on %F-F

plot(xaxis,S_test{2,6},':r','linewidth',2);hold on %F-C
plot(xaxis,S_test{2,2},':b','linewidth',2);hold on %F-F

%legend('ALL','S-S','S-N','F-C','F-F','location','Southeast');
